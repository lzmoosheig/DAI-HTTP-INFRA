...
### How to get datas from the dynamic server
We have created a script named: "loadPasswords.js" located in /docker-images/apache-php-image/content/js. This script will get JSON data generated by the dynamic server using Ajax request. It will get data from localhost/api so you need to be running the stack.
