...
We have created a script named: "loadPasswords.js" located in /docker-images/apache-php-image/content/js. This script will get JSON data generated by the dynamic server using Ajax request. It will get data from localhost/api.
